...
import { FrontendLanguage, t } from '@/lib/i18n'
...
function getDefaultHomeContent(lang: FrontendLanguage): HomeContent {
  if (lang === 'ja') {
    return {
      featuredTitle: '注目商品',
...
async function getHomeContent(lang: FrontendLanguage): Promise<HomeContent> {
  const defaultHomeContent = getDefaultHomeContent(lang)
  try {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-lg">{t(lang, 'home.noFeatured')}</p>
